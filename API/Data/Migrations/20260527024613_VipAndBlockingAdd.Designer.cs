...
namespace API.Data.Migrations
{
    ...
    [Migration("20260527024613_VipAndBlockingAdd")]
    partial class VipAndBlockingAdd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.BlockMember", b =>
                {
            ...
            modelBuilder.Entity("API.Entities.BlockMember", b =>
                {
                    b.HasOne("API.Entities.AppUser", "SourceMember")
                        .WithMany("BlockedMembers")
                        .HasForeignKey("SourceMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.AppUser", "TargetMember")
                        .WithMany("BlockedByMembers")
            ...
            modelBuilder.Entity("API.Entities.AppUser", b =>
                {
                    b.Navigation("BlockedByMembers");

                    b.Navigation("BlockedMembers");
